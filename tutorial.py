...
class Tutorial():
    def __init__(self):
        ...
        *: My current location
        ...
        Sta,Gol,Fin...: Initials from the first letter of the room name. They may have the same initials, but they may actually be different rooms.
        ...
        Currently (V1.1), there are 6 types of stats: Agility, Defense, Learning, Strength (Physical), Magic Affinity, and Stability.
        ...
        ===== Encyclopedia =====
        This is an list containing the monsters the player have encountered so far.
        You can roughly see the HP and damage of the monster.
